...
(function() {
    ...
    clearCookie();
    //填写刷问卷的网址
    var wenjuan_url = 'https://www.wjx.cn/vj/h4NJY1h.aspx';

    //https://www.wjx.cn/vm/h4NJY1h.aspx
  ...
  //提交函数
    ...
    setTimeout( function(){
        ...
        //document.querySelector('#rectBottom').click()
        setTimeout( function(){
            //document.querySelector('#rectBottom').click()
